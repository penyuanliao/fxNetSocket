...
/**
 * @typedef {number} Versions
 * @enum {String} Versions
 * @readonly
 */
FxSocket.Versions = Object.freeze({
    v1: "v1",
    v2: "v2"
})
/**
 ...
 * @return {{msg: string, start: number, byteLength: *}|boolean|undefined|{}|{fin, opcode: (number|Number|Boolean)}|{msg: string, opcode: number}}
 */
