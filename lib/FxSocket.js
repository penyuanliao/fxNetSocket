...
function FxSocket(socket, bufferPool)
{
    ...
    Object.defineProperties(this, {
        "originAddress": {
            get:function () { return (typeof self.headers != "undefined") ? self.headers["X-Forwarded-For"] : undefined; },
            configurable: false,
            enumerable: false}
    })
};
...
FxSocket.prototype.read = function (data) {
    ...
    if (this.mode === 'ws') {
        ...
        if (this.protocol.fin == true) {
            this.protocol['msg'] = this.tmpSource.toString();
            this.tmpSource = Buffer.from([]);
        } else {
            return obj;
        }
