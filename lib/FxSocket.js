...
FxSocket.prototype.write = function (data) {
    if (this.mode === 'ws') {
        var buf = this.emit_websocket(data);
...
FxSocket.prototype.read = function (data) {
    ...
    if (this.mode === 'ws') {
        ...
        NSLog.log('log','FxSocket ws-opcode(read): ' + this.protocol.opcode );
...
FxSocket.prototype.__lookupSetter__("binaryType", function (binarytype) {
