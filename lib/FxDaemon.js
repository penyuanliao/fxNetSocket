...
Fxdaemon.prototype = {
    ...
    init: function () {
        ...
        (function run() {
            console.log('process start %s (%d)', context._modulePath, context._cpfpid);
            ...
            if (context.pkgFile === false) {
                ...
                context._args.unshift(context._modulePath);
                context._cpf = cp.spawn(context.cmd, context._args, context._options);
                // redirect the child process standard output into files
                if (typeof context._options.stdoutFile == "string") {
                    context._options.stdio[1] = fs.openSync(context._options.stdoutFile, "a");
                } else {
                ...
                if (typeof context._options.stderrFile == "string") {
                    context._options.stdio[2] = fs.openSync(context._options.stderrFile, "a");
                } else {
            ...
            context._cpf.on('exit', function (code, signal) {
                ...
                if (context.pkgFile == true) {
                    if (typeof context._cpf.stdout != "undefined") context._cpf.stdout.removeAllListeners("data");
                    if (typeof context._cpf.stderr != "undefined") context._cpf.stderr.removeAllListeners("data");
                }
            ...
            context._cpf.on("message", function (message, handle) {
                ...
                if (message.evt === "socket") {
                    ...
                    if (message.action == "creationComplete") {
                        context.creationComplete = (typeof message.bool == "boolean") ? message.bool : true;
                    }
                }
